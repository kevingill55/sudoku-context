  ...
  return (
    ...
    >
      ...
      >
        ...
        <TitleButton label='Check' onClick={() => onCheck({ board, indices, updateCheckedIndices, toggleCheckBoard })} />
        <TitleButton label='New Puzzle' onClick={() => toggleNewGame(true)} />
        <TitleButton label='Reset' onClick={() => onReset({ resetBoard, initialBoard })} />
      </Box>
    </Box>
  );
};
